...
\author[A]{\fnms{Angelo} \snm{Carreon}
  \ead[label=e1]{jaccarre@uwaterloo.ca}}
  ,
\author[A]{\fnms{Hoseok} \snm{Lee}
  \ead[label=e2,mark]{h349lee@uwaterloo.ca}}
  
\author[A]{\fnms{Joy} \snm{Chen}
  \ead[label=e2,mark]{z635chen@uwaterloo.ca}}
  \textbackslash and
\author[A]{\fnms{Third} \snm{Author}
  \ead[label=e3,mark]{s58shen@uwaterloo.ca}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Alley: Type of alley access to property}
\FunctionTok{sum}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(housing}\SpecialCharTok{$}\NormalTok{Alley))      }\CommentTok{\# only 198 observations}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Pool.QC: Pool quality}
\FunctionTok{sum}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(housing}\SpecialCharTok{$}\NormalTok{Pool.QC))    }\CommentTok{\# only 13 observations}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Misc.Feature: Miscellaneous feature not covered in other categories}
\FunctionTok{sum}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(housing}\SpecialCharTok{$}\NormalTok{Misc.Feature)) }\CommentTok{\# only 106 observations}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Fence: Fence quality}
\FunctionTok{sum}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(housing}\SpecialCharTok{$}\NormalTok{Fence))  }\CommentTok{\# only 572 observations}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Fireplace.Qu: Fireplace quality}
\FunctionTok{sum}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(housing}\SpecialCharTok{$}\NormalTok{Fireplace.Qu)) }\CommentTok{\# only 1508 observations}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(housing}\SpecialCharTok{$}\NormalTok{SalePrice)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{options}\NormalTok{(}\AttributeTok{scipen=}\DecValTok{10}\NormalTok{)}
\FunctionTok{hist}\NormalTok{(housing}\SpecialCharTok{$}\NormalTok{SalePrice, }\AttributeTok{xlab =} \StringTok{"Property Sale Price"}\NormalTok{, }\AttributeTok{main =} \StringTok{"Histogram of Sale Price"}\NormalTok{)}
\FunctionTok{lines}\NormalTok{(housing}\SpecialCharTok{$}\NormalTok{SalePrice, }\AttributeTok{col =} \DecValTok{4}\NormalTok{, }\AttributeTok{lwd =} \DecValTok{2}\NormalTok{)}
\FunctionTok{par}\NormalTok{(}\AttributeTok{new=}\ConstantTok{TRUE}\NormalTok{)   }
\FunctionTok{plot}\NormalTok{(}\FunctionTok{density}\NormalTok{(housing}\SpecialCharTok{$}\NormalTok{SalePrice), }\AttributeTok{col=}\DecValTok{2}\NormalTok{, }\AttributeTok{lwd =} \DecValTok{2}\NormalTok{, }\AttributeTok{yaxt=}\StringTok{"n"}\NormalTok{, }\AttributeTok{xaxt=}\StringTok{"n"}\NormalTok{,}
     \AttributeTok{bty=}\StringTok{\textquotesingle{}n\textquotesingle{}}\NormalTok{, }\AttributeTok{xlab=}\StringTok{""}\NormalTok{, }\AttributeTok{ylab=}\StringTok{""}\NormalTok{, }\AttributeTok{main=}\StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{)}
\FunctionTok{axis}\NormalTok{(}\DecValTok{4}\NormalTok{, }\AttributeTok{las=}\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{hist}\NormalTok{(}\FunctionTok{log}\NormalTok{(housing}\SpecialCharTok{$}\NormalTok{SalePrice), }\AttributeTok{xlab =} \StringTok{"log(Sale Price)"}\NormalTok{, }\AttributeTok{main =} \StringTok{"Histogram of log(Sale Price)"}\NormalTok{, }\AttributeTok{breaks =} \DecValTok{20}\NormalTok{)}
\FunctionTok{par}\NormalTok{(}\AttributeTok{new=}\ConstantTok{TRUE}\NormalTok{)   }
\FunctionTok{plot}\NormalTok{(}\FunctionTok{density}\NormalTok{(}\FunctionTok{log}\NormalTok{(housing}\SpecialCharTok{$}\NormalTok{SalePrice)), }\AttributeTok{col=}\DecValTok{2}\NormalTok{, }\AttributeTok{lwd =} \DecValTok{2}\NormalTok{, }\AttributeTok{yaxt=}\StringTok{"n"}\NormalTok{, }\AttributeTok{xaxt=}\StringTok{"n"}\NormalTok{,}
     \AttributeTok{bty=}\StringTok{\textquotesingle{}n\textquotesingle{}}\NormalTok{, }\AttributeTok{xlab=}\StringTok{""}\NormalTok{, }\AttributeTok{ylab=}\StringTok{""}\NormalTok{, }\AttributeTok{main=}\StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{)}
\FunctionTok{axis}\NormalTok{(}\DecValTok{4}\NormalTok{, }\AttributeTok{las=}\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{STAT-444-FINAL-PROJECT-PROPOSAL_files/figure-latex/unnamed-chunk-4-2.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Subset of numeric columns}
\NormalTok{numericHousingData }\OtherTok{\textless{}{-}}\NormalTok{ newHousing[, }\FunctionTok{sapply}\NormalTok{(newHousing, is.numeric)]}

\CommentTok{\# Calculate the correlations between each numeric column and the response variable}
\NormalTok{correlations }\OtherTok{\textless{}{-}} \FunctionTok{cor}\NormalTok{(numericHousingData[, }\SpecialCharTok{{-}}\FunctionTok{which}\NormalTok{(}\FunctionTok{names}\NormalTok{(numericHousingData) }\SpecialCharTok{==} \StringTok{"SalePrice"}\NormalTok{)], }
\NormalTok{                    numericHousingData}\SpecialCharTok{$}\NormalTok{SalePrice, }\AttributeTok{use =} \StringTok{"complete.obs"}\NormalTok{)}

\CommentTok{\# rank the correlations into two groups (positive and negative)}
\NormalTok{posCorrelations }\OtherTok{\textless{}{-}}\NormalTok{ correlations[correlations[,}\DecValTok{1}\NormalTok{] }\SpecialCharTok{\textgreater{}=} \DecValTok{0}\NormalTok{, ]}
\NormalTok{negCorrelations }\OtherTok{\textless{}{-}}\NormalTok{ correlations[correlations[,}\DecValTok{1}\NormalTok{] }\SpecialCharTok{\textless{}} \DecValTok{0}\NormalTok{, ]}

\CommentTok{\# Print the correlations}
\FunctionTok{print}\NormalTok{(}\FunctionTok{sort}\NormalTok{(posCorrelations,}\AttributeTok{decreasing=}\ConstantTok{TRUE}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cor\_matrix }\OtherTok{\textless{}{-}} \FunctionTok{cor}\NormalTok{(numericHousingData, }\AttributeTok{use =} \StringTok{"complete.obs"}\NormalTok{)}

\NormalTok{corr\_df }\OtherTok{=} \FunctionTok{data.frame}\NormalTok{(cor\_matrix)}
\NormalTok{corr\_df}\SpecialCharTok{$}\NormalTok{var }\OtherTok{=} \FunctionTok{row.names}\NormalTok{(corr\_df)}

\CommentTok{\# Positive}
\NormalTok{corr\_df1 }\OtherTok{=}\NormalTok{ reshape2}\SpecialCharTok{::}\FunctionTok{melt}\NormalTok{(corr\_df, }\AttributeTok{value\_name =} \StringTok{"Corr"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{corr\_df1 }\OtherTok{=}\NormalTok{ corr\_df1[(corr\_df1}\SpecialCharTok{$}\NormalTok{value }\SpecialCharTok{\textgreater{}} \FloatTok{0.7} \SpecialCharTok{\&}\NormalTok{ corr\_df1}\SpecialCharTok{$}\NormalTok{value }\SpecialCharTok{\textless{}} \DecValTok{1}\NormalTok{),]}
\FunctionTok{print}\NormalTok{(corr\_df1[}\FunctionTok{order}\NormalTok{(corr\_df1}\SpecialCharTok{$}\NormalTok{value,}\AttributeTok{decreasing=}\ConstantTok{TRUE}\NormalTok{),])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{maxpos }\OtherTok{\textless{}{-}}\NormalTok{ corr\_df1[}\FunctionTok{order}\NormalTok{(corr\_df1}\SpecialCharTok{$}\NormalTok{value),]}

\CommentTok{\# Negative}
\NormalTok{corr\_df2 }\OtherTok{=}\NormalTok{ reshape2}\SpecialCharTok{::}\FunctionTok{melt}\NormalTok{(corr\_df, }\AttributeTok{value\_name =} \StringTok{"Corr"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{corr\_df2 }\OtherTok{=}\NormalTok{ corr\_df2[(corr\_df2}\SpecialCharTok{$}\NormalTok{value }\SpecialCharTok{\textless{}} \SpecialCharTok{{-}}\FloatTok{0.7} \SpecialCharTok{\&}\NormalTok{ corr\_df2}\SpecialCharTok{$}\NormalTok{value }\SpecialCharTok{\textgreater{}} \SpecialCharTok{{-}}\DecValTok{1}\NormalTok{),]}
\FunctionTok{print}\NormalTok{(corr\_df2[}\FunctionTok{order}\NormalTok{(corr\_df2}\SpecialCharTok{$}\NormalTok{value,}\AttributeTok{decreasing=}\ConstantTok{TRUE}\NormalTok{),])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{maxneg }\OtherTok{\textless{}{-}}\NormalTok{ corr\_df2[}\FunctionTok{order}\NormalTok{(corr\_df2}\SpecialCharTok{$}\NormalTok{value),]}

\CommentTok{\# Correlation matrix including only the top positive and negative correlations}
\NormalTok{names }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(maxpos}\SpecialCharTok{$}\NormalTok{var, maxneg}\SpecialCharTok{$}\NormalTok{var)}
\NormalTok{topcormat }\OtherTok{\textless{}{-}}\NormalTok{ cor\_matrix[names, names]}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{table}\NormalTok{(housing}\SpecialCharTok{$}\NormalTok{Street))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{table}\NormalTok{(housing}\SpecialCharTok{$}\NormalTok{Utilities))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{table}\NormalTok{(housing}\SpecialCharTok{$}\NormalTok{Roof.Matl))}
\end{Highlighting}
\end{Shaded}
