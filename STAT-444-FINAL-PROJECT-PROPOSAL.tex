...
\includegraphics{unnamed-chunk-6-1.pdf}
\caption{Histogram of sale price (top); histogram of log sale price (bottom).\label{}}
\end{figure}

% In the current PDF version, "2.4. Correlations with the dependent variable." is on its own line, and it looks kind of awkward. I'm just putting this line break here to put it on the next page instead.
\hfill\break
...
% Another line break to fix the formatting.
\hfill\break
