...
# setwd("C:/Users/Angelo/OneDrive - University of Waterloo/School/University/Year 4/4B/STAT 444/A2")
```
...
```{r, echo=FALSE}
# replace with file path to the dataset
setwd("C:/Users/Angelo/OneDrive - University of Waterloo/School/University/Year 4/4B/STAT 444/Final Project")
...
* the distribution of Sale Price looks very right-skewed:
most values are clustered around the left tail while the right tail is longer (extreme high values)
