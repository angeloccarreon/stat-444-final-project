...
Journal of Statistics, we have selected a dataset of housing prices in Ames, 
Iowa, along with other pertinent features. In today's dynamic real estate 
...
```{r, echo=FALSE, fig.show='hold', fig.align='center', fig.cap="Histogram of Sale Price (top) and Log Sale Price (bottom)\\label{}"}
options(scipen=10)
